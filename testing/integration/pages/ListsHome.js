...
module.exports = {
  ...
  openEditListDropdown(listIndex){
    ...
    //pause();    
    I.click({css: ".list-wrapper > div > span:nth-child(2) > div:nth-child("+listIndex+") > div.more-options-wrapper > svg"});
  ...
  destroyDummyList(listIndex){
    ...
    I.click({css: ".list-wrapper > div > span:nth-child(2) > div:nth-child("+listIndex+") > div.more-options-wrapper > svg"});
    I.click({css: ".list-wrapper > div > span:nth-child(2) > div:nth-child("+listIndex+") > div.more-options-wrapper > div > ul > li:nth-child(2)"});
    //I.click("Delete");
  ...
  enterList(listIndex){
    ...
    I.click({css: ".list-wrapper > div > span:nth-child(2) > div:nth-child("+listIndex+")"});
  },
