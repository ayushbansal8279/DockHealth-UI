...
import ListOfTasksContainer from '../LEGACY_task/ListOfTasksContainer';

class PersonTaskListContainer extends PureComponent {
  constructor(props) {
    super(props);
  ...
  renderTaskListName(taskStatus, searchedTasks) {
    const groupedTasks = this.groupBy(searchedTasks, task =>
          ...
          <span
            className={
              this.props.currentTaskHistory
                ? 'accordion-title task-search-list-name'
                : 'accordion-title task-search-list-name large-8 large-offset-2'
            }
          >
            <b>{listName}</b>
          </span>
    ...
    return (
      <div className="tasks-container">
        <div
          className={
            this.props.currentTaskHistory
              ? 'large-8 columns left-column'
              : 'large-12 columns left-column'
          }
        >
          <div className="row expanded collapse">
            ...
            <div className="columns large-12">
              <div className="show-completed text-center">
                <a
                  className="toggle-completed button primary small"
                  onClick={e => this.pullCompletedTasks()}
                >
                    ...
                    <div className="row">
                      ...
                      <div className="columns shrink more-options-wrapper">
                        <svg
                          ...
                          onClick={e => this.closeAuditHistory()}
                        >
