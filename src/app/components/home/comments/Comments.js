...
class Comments extends React.PureComponent {
  ...
  render() {
    const {
      userId, comments, submit, disabled,
    } = this.props;

    /* eslint-disable max-len */
    const sameDay = (comment1, comment2) => comment1.dateCreated.date() === comment2.dateCreated.date();
    const sameCreator = (comment1, comment2) => comment1.creator.userName === comment2.creator.userName;
