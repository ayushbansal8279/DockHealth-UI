...
class PersonTaskListContainer extends BaseComponent {
  ...
  renderAuditHistory() {
    ...
    renderTaskListName(taskStatus, searchedTasks){
      const groupedTasks = this.groupBy(searchedTasks, task => (task.taskList?task.taskList.listName:""));
...
export default connect(mapStateToProps, mapDispatchToProps)(PersonTaskListContainer);
