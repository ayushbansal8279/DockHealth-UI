...
export const SUBSCRIPTION_PLANS = [
  {
    ...
    features: [
      ...
      '2 SmartFlow templates',
      'Custom task statuses',
      'Analytics dashboard',
      'Patient labels/tags',
      'Unlimited patient notes & files',
  ...
  },
  {
    ...
    label: 'Premium',
    description: 'Best for medium and large companies',
    color: '#047A95',
  ...
  },
  {
    ...
    features: [
      ...
      'Email tasks',
      'SMS tasks',
      'Write a note back to EHR*',
      'Fax tasks*',
      'eSign tasks*',
      'Single task collaboration (beta)',
      'Secure emails sent via PauBox',
      'Task escalation rules*',
      'Access to API platform (additional subscription)',
      'Access to secure data feed for analytics (additional subscription)',
    ],
  },
  {
    ...
    label: 'Enterprise',
    description:
      'For teams with complex workflows, requiring deep integrations and customization',
    color: '#000000',
    ...
    features: [
      ...
      'Webhooks',
      'Dedicated sandbox and dev environment with support',
      'White label / iFrame',
      'SSO',
      'Embedded widgets',
      'Weekly meetings',
      'Dedicated Slack channel',
      'Integration and automation options with Professional Services',
