...
export const ProfileDetailsNotesContainer = styled.div`
  display: flex;
...
export const ProfileDetailsNotesListContainer = styled.div`
  display: flex;
  flex-direction: column;
  max-height: 225px;
...
export const ProfileNoteInformation = styled.div`
  display: flex;
  flex-direction: column;
  width: 100%;
...
export const ProfileNoteAuthor = styled.div`
  color: ${palette.coolGrey2};
`;

export const ProfileNoteDescription = styled.div`
  border: none;
...
export const ProfileNoteTextarea = styled.textarea`
  border: none;
  box-shadow: none;
  background-color: transparent;
  outline: none;
