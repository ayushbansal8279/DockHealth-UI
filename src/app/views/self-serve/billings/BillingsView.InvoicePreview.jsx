...
const downloadPdf = memoizeWith(identity, ({ url }) =>
  axios({
    url,
    method: 'get',
    responseType: 'blob',
...
const InvoicePreview = React.memo(
  ({ url, isPreviewOpen, hidePreview, label, numberLabel }) => {
    ...
    return (
      ...
      >
        <AttachmentPreviewHeader>
          ...
          >
            <AttachmentPreviewHeaderLabel>{label}</AttachmentPreviewHeaderLabel>
            <AttachmentPreviewHeaderSmallLabel>
              {numberLabel}
            </AttachmentPreviewHeaderSmallLabel>
          </AttachmentPreviewHeaderSection>
