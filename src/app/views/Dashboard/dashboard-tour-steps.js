...
export const FIRST_TOUR_STEPS = [
  ...
  },
  {
    ...
    description:
      "The Lists page you’re familiar with is still there, and you can still easily access it. We've simply created a new view that shows you all the tasks assigned to you, from all the lists of which you’re an owner or member.",
  },
];
