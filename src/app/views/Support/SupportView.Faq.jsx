...
const faqArticles = [
  ...
  {
    title: 'How can I add patient/client context to a task?',
    content: `For each task in Dock, a patient/client can be linked so that each task or subtask has patient/client context. Adding a patient/client is easy and can be done by simply searching or selecting an existing patient/client form the Dock directory or creating a new patient/client profile. A new patient/client profile can be created in the process of creating a task or created in the patient/client page. Adding patient/client context to a task offers many benefits including, easy access to contact information for calling a patient/client back (especially in the mobile app) and being able to see all the tasks for a patient/client across all of your lists. You can also create short notes in the patient/client profile for little reminders and “one-liners” on a patient/client.`,
  },
  {
