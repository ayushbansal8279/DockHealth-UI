      ...
      <div className="wrapper columns large-12">
        <div className="row expanded text-center">
          <div className="columns large-12 top-buffer">
            <h5>
              Security and protected health information is important to us. We
              noticed your email address is not associated with an organization
              that has been given access to Dock Health
            </h5>
          </div>
        </div>
        <div className="row expanded text-center">
          <div className="columns large-12 top-buffer">
            <h5>
              We will send an email to you with a few quick steps to gain
              access. Please check for an email from Dock Health shortly
            </h5>
            <h5>
