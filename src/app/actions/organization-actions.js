...
export const getOrganizationById =
  ...
  (dispatch) => {
    ...
    return handleOrganizationResponse({
      fetchMethod: () =>
        OrganizationApi.getOrganization(organizationIdentifier),
      dispatch,
    });
  };
...
export const setPaymentNewPlan =
  ({ newPlan }) =>
  (dispatch) => {
    dispatch({
...
export const checkBAASignedStatus = (organizationIdentifier) => (dispatch) => {
  ...
  return handleOrganizationResponse({
    fetchMethod: () => {
      const checkBAASignedStatusWithMemo =
...
export const getConfigurationForReferral =
  ({ referralCode }) =>
  (dispatch) => {
    if (!referralCode) {
