...
const EditPencil = ({}) => {
  const [color, setColor] = useState('#8492A4');
  return (
    <div
      onMouseEnter={() => setColor('#4BB3FD')}
      onMouseLeave={() => setColor('#8492A4')}
    >
      <svg
        width="16"
        height="16"
      ...
      >
        <g clip-path="url(#clip0_3842_28243)">
          <path
