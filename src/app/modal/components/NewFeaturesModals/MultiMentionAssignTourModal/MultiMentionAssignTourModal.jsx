...
import { MultiMentionAssignStep } from './Steps';

const TOUR_STEPS_COMPONENTS = [MultiMentionAssignStep];

const MultiMentionAssignTourModal = ({ closeModal }) => {
...
export default MultiMentionAssignTourModal;
