...
import { AutoAssignDueDateStep, CustomizeHomeScreenStep } from './Steps';

const TOUR_STEPS_COMPONENTS = [CustomizeHomeScreenStep, AutoAssignDueDateStep];

const HomeImprovementsTourModal = ({ closeModal }) => {
...
export default HomeImprovementsTourModal;
