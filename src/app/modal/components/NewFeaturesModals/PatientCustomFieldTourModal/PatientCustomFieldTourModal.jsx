...
import { TaskDetailsStep, PatientCustomFieldsStep } from './Steps';

const TOUR_STEPS_COMPONENTS = [TaskDetailsStep, PatientCustomFieldsStep];

const PatientCustomFieldTourModal = ({ closeModal }) => {
...
export default PatientCustomFieldTourModal;
