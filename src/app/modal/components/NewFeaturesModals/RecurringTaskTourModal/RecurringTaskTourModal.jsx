...
import { RecurringTaskIntroStep, RecurringTaskScheduleStep } from './Steps';

const TOUR_STEPS_COMPONENTS = [
  RecurringTaskIntroStep,
  RecurringTaskScheduleStep,
];

const RecurringTaskTourModal = ({ closeModal }) => {
...
export default RecurringTaskTourModal;
