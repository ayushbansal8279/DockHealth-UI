...
import { NotificationSettingsStep, SpeedOptimizationStep } from './Steps';

const TOUR_STEPS_COMPONENTS = [NotificationSettingsStep, SpeedOptimizationStep];

const NotificationSettingsTourModal = ({ closeModal }) => {
...
export default NotificationSettingsTourModal;
