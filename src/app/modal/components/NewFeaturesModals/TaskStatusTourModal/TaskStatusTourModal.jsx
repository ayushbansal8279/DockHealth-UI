...
import { TaskStatusIntroStep, TaskStatusEditStep } from './Steps';

const TOUR_STEPS_COMPONENTS = [TaskStatusIntroStep, TaskStatusEditStep];

const TaskStatusTourModal = ({ closeModal }) => {
...
export default TaskStatusTourModal;
